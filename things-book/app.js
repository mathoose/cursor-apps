(function () {
  ...
  function setView(view, listId) {
    ...
    document.getElementById('importPhotosBtn').hidden = !(view === 'home' || (view === 'list' && isUncategorized(listId)));
  ...
  function handlePhotoFiles(files) {
    ...
    snapshotFile(file).then(function (snap) {
      return preparePhotoBlob(snap);
    }).then(function (blob) {
      clearPendingPhoto();
