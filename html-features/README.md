...
| Philly walking map (OSM + walking box + circle pins) | [philly-walk-map/](philly-walk-map/) | Bounds + pins approved | Any in-app Philly map used on foot: Navy Yard → Fishtown / Olde Kensington, 45th St → river; white-bordered pins with names on zoom |
