...
| Philly walking map (OSM + walking box) | [philly-walk-map/](philly-walk-map/) | Bounds approved | Any in-app Philly map used on foot: Oregon Ave → Fishtown / Olde Kensington, 45th St → river |
